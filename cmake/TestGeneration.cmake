...
function(generate_dynamic_tests_file DISCOVERY_REGISTRY OUTPUT_FILE)
    ...
    foreach(LAYER_NUM ${UNIQUE_LAYERS})
        ...
        string(APPEND DYNAMIC_TESTS_CONTENT "            \n")
        string(APPEND DYNAMIC_TESTS_CONTENT "            try {\n")
        ...
        string(APPEND DYNAMIC_TESTS_CONTENT "                }\n")
        string(APPEND DYNAMIC_TESTS_CONTENT "                \n")
        string(APPEND DYNAMIC_TESTS_CONTENT "            } catch (const std::exception& e) {\n")
        string(APPEND DYNAMIC_TESTS_CONTENT "                // Log exception with buffer dump before failing\n")
        string(APPEND DYNAMIC_TESTS_CONTENT "                log_test_exception(test_case.name, ${LAYER_NUM}, e.what());\n")
        string(APPEND DYNAMIC_TESTS_CONTENT "                FAIL() << \"Layer${LAYER_NUM} exception for \" << test_case.name << \": \" << e.what();\n")
        string(APPEND DYNAMIC_TESTS_CONTENT "            }\n")
        string(APPEND DYNAMIC_TESTS_CONTENT "            \n")
