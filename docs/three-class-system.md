...
Data classes contain only state (fields) and basic memory management operations. They cannot have semantic methods or business logic.
...
2. **Optional constructor/destructor**: For managing paired data classes
...
- **Constructor**: Returns instance of paired data class
- **Destructor**: Cleans up data class instance (called automatically)
- **Pairing**: One functional class can manage one data class type
